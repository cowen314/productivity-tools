...
def main():
    """
    Onutline:
    - build a tool that will take a generic list of search terms (product names) and return metrics for those items
        - metrics such as
            - average unit price (will need a way to figure out how many units each entry is selling)
            - the quality of reviews (probably very difficult)
        - implementation details
            - decent tutorial here (https://www.digitalocean.com/community/tutorials/how-to-crawl-a-web-page-with-scrapy-and-python-3) and here (https://www.scrapehero.com/tutorial-how-to-scrape-amazon-product-details-using-python-and-selectorlib/)
            - use URLs in the form https://www.amazon.com/s?k=<something> to search for products 
