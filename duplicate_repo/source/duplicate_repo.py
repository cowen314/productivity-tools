...
parser.add_argument('--protocol', help="Protocol to use for git repository. Either HTTPS or SSH. (default: %s)" % config["default_protocol"], choices=["HTTPS", "SSL"], default=config["default_protocol"], dest="protocol")
